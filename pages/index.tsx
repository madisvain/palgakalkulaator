                            ...
                            <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                              <div className="relative gap-8 bg-white p-4">
                                <p className="text-gray-500">
                                  Sotsiaalmaksuseaduse § 21 alusel kehtestatav
                                  sotsiaalmaksu maksmise aluseks olev{" "}
                                  <a href="https://www.riigiteataja.ee/akt/RES2021#para2lg7">
                                    kuumäär
                                  </a>{" "}
                                  on 2021.-2022 aastal 584 eurot, seega
                                  sotsiaalmaksu minimaalne kohustus on 192,72
                                  eurot kuus. Vt. täpsemalt
                            ...
                            <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                              <div className="relative gap-8 bg-white p-4">
                                <p className="font-normal text-gray-500">
                                  ...
                                  <br />
                                  <br />
                                  Aastatuluga kuni 14 400 eurot on maksuvaba
                                  tulu 6000 eurot aastas.
                                  <br />
                                  <br />
                                  Aastatulu kasvades 14 400 eurolt 25 200 euroni
                                  väheneb maksuvaba tulu vastavalt valemile 6000
                                  – 6000 ÷ 10 800 × (tulu summa – 14 400).
                                  <br />
                                  <br />
                                  Aastatuluga üle 25 200 euro on maksuvaba tulu
                                  0.
                                  <br />
                                  <br />
                                  Vt. ka{" "}
                                  ...
                                  tööandja kulud näiteks brutotöötasu tõstmisel
                                  või kui palju tõuseb töötaja netopalk kui
                                  brutopalga tõus on näiteks 50 eurot, siis
                                  jätke väli «Arvesta maksuvaba tulu» tühjaks
                                  ning sisestage lähteandmetesse ainult
                                  palgamuutuse summa.
                                </p>
                              </div>
                            </div>
                        ...
                        >
                          <Popover.Panel className="absolute left-1/2 z-10 mt-1 w-80 max-w-sm -translate-x-1/2 transform px-4 sm:px-0 lg:max-w-3xl">
                            <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                              <div className="relative gap-8 bg-white p-4">
                                <p className="text-gray-500">
                                  Töötuskindlustusmakse määrad sätestatakse
                                  töötuskindlustuse seaduse § 41 lõike 4 alusel
                                  Vabariigi Valitsuse määrusega.
                                  <br />
                                  <br />
                                  Tööandja töötuskindlustusmakse määr 2020–2023.
                                  aastal on 0,8%
                                  <br />
                                  <br />
                                  Töötaja (kindlustatu) töötuskindlustusmakse
                                  määr 2020–2023. aastal on 1,6%
                                  <br />
                                  <br />
                                  Töötuskindlustuse seaduse kohaselt on antud
                                  makse maksjateks s.h. töötaja, avalik
                                  teenistuja, võlaõigusliku lepingu alusel
                                  teenust osutav füüsiline isik. Töötaja ja
                                  tööandja makse määrad järgmiseks
                                  kalendriaastaks kehtestab Vabariigi Valitsus
                                  hiljemalt jooksva kalendriaasta 1.
                                  detsembriks.
                                  <br />
                                  <br />
                                  NB! Juhul kui töötaja (kindlustatu) on jõudnud
                                  vanaduspensioniikka või talle on määratud
                                  riikliku pensionikindlustuse seaduse §-s 9
                                  sätestatud ennetähtaegne vanaduspension,
                                  arvestatakse töötajale töötuskindlustusmakset
                                  üksnes tööandjale kehtestatud määras.
                                </p>
                              </div>
                            </div>
                          </Popover.Panel>
                            ...
                            <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                              <div className="relative gap-8 bg-white p-4">
                                <p className="text-gray-500">
                                  ...
                                  sambaga vabatahtlikult liitunud või seadusega
                                  kohustatud residendist füüsiline isik (kes on
                                  esitanud maksete jätkamise avalduse), kui tema
                                  elukoht on Eestis või kui ta viibib Eestis 12
                                  järjestikuse kalendrikuu jooksul vähemalt 183
                                  päeva. Makse määraks on 2% kogumispensionide
                                  seaduse § 7 lõikes 1 nimetatud summadelt.
                                </p>
                              </div>
                            </div>
                          </Popover.Panel>
      ...
      <footer className="bg-white">
        <div className="mx-auto max-w-7xl overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-8 text-center text-base text-gray-400">
            ...
            <a href="https://www.arveldaja.com/">Arveldaja OÜ</a>.
          </p>
        </div>
      </footer>
    </>

      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row gap-4 pt-12 pb-16 lg:pt-24 lg:pb-32 items-center border-b border-b-[#E9E7E5]">
          ...
          <div className="basis-3/5">
            <h4 className="mb-6">
              <Trans>Maksuinfo 2025</Trans>
            </h4>
            <ul className="list-outside list-disc space-y-4 ml-4">
              <li>
                <Trans>Tulumaksu kinnipidamise määr on</Trans> <strong className="font-bold">22%</strong>{" "}
                {/*<a
              ...
              <li>
                <Trans>
                  Sotsiaalmaksu minimaalne kohustus Töölepingu puhul on <strong>820 EUR</strong> x 0,33% =
                </Trans>{" "}
                <strong>
                  <Trans>270.60 EUR/kuus</Trans>
                </strong>{" "}
                <a
              ...
              <li>
                ...
                <ul className="list-outside list-disc ml-8">
                  <li>
                    ...
                    <a
                      href="https://www.riigiteataja.ee/akt/103102023019?leiaKehtiv#para1"
                      className="font-semibold text-xs underline underline-offset-4"
                      target="_blank"
                    >
                      VV määrus 29.09.2023 nr 88
                    </a>
                  </li>
                  <li>
                    <Trans>
              ...
              <li>
                <Trans>
                  Kogumispensioni makse määr on 2%, 4% või 6%, sõltuvalt inimese avaldusest pensioniregistri pidajale.
                  Kogumispensioni makse määra saab kontrollida
                </Trans>{" "}
                <a
                ...
                >
                  <strong>
                    <Trans>Pensionikeskuses</Trans>
                  </strong>
                </a>{" "}
                <a
                  href="https://www.riigiteataja.ee/akt/103122024015?leiaKehtiv#para9"
                  className="font-semibold text-xs underline underline-offset-4"
                  target="_blank"
                >
                  KPS § 9
